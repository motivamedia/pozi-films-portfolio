...
export const clientBrands: ClientBrand[] = [
  ...
  { name: "Nutraxin", logo: logoNutraxin, size: "h-10" },
  { name: "Karaca", logo: logoKaraca, size: "h-10" },
  { name: "Bioxcin", logo: logoBioxcin },
  { name: "GNC Trkcll", logo: logoGnctrkcll, size: "h-10" },
  ...
  { name: "Auntie Anne's", logo: logoAuntieAnnes, size: "h-10" },
  ...
  { name: "Global Medical Forum", logo: logoGMF, size: "h-10" },
